...
class Project:
    ...
    def _build_list(self):
        ...
        self.top_display.grid(row=0, column=self.column)
        ...
        self.input.grid(row=1, column=self.column)
    ...
    def update_listbox(self):
        ...
        for i, it in enumerate(self.items_list):
            ...
            # b = tkinter.Checkbutton(self.root, text=it.text, variable=v[-1], padx=0, pady=0)
            b = tkinter.Checkbutton(self.root, text=it.text, variable=v[-1])
            # b.grid(row=i + 2, column=self.column, sticky="W" + "N")
            b.grid(row=i + 2, column=self.column, sticky="w")
        print("V:", v)
